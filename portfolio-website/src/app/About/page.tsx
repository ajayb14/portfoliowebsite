...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-custom p-4 sm:p-8">
      <header>
        <Navbar />
      </header>
      <main className="flex flex-col items-center text-center mt-[250px]">
        <h1 className="text-2xl sm:text-4xl font-bold mb-4">Hi, I'm Ajay</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-20 mb-8 max-w-md w-full">
